...
class AccountTests(APITestCase):
    def setUp(self):
        ...
        serializer = ResultSerializer(data=self.result1)
    ...
    def test_update_result(self):
        ...
        data = {
            ...
            "Nds_imrt": [
                {
                    "code_c6_p11_6": 0.066, "code_c6_p12_6": 0.024, "code_c6_p13_6": 0.015, "code_c6_p14_6": -0.01,
                    "code_c6_p15_6": 0.005,
                    "code_c6_p16_6": 0.018, "code_c6_p17_6": 0.024,
                    "code_c7_p11_6": 0.029, "code_c7_p12_6": 0.036, "code_c7_p13_6": 0.033, "code_c7_p14_6": -0.009,
                    "code_c7_p15_6": 0.014,
    ...
    def test_create_resultlist(self):
        ...
        self.assertEqual(result.Nds_imrt.get().code_c6_p11_6, decimal.Decimal('0.02600'))
        self.assertEqual(result.Nds_imrt_misdelivery.get().code_c6_p11_6, 1)
        result3 = Result.objects.get(id=3)
        self.assertEqual(result3.FacilityName, 'Drever')
